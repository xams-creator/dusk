...
export interface Plugin {
    ...
    onStateChange?: <Context extends PluginHookContext = PluginHookContext>(ctx: Context, next: Function, oldState: Readonly<any>, newState: Readonly<any>, model: DuskModel, app: DuskApplication) => void
    onError?: <Context extends PluginHookContext = PluginHookContext>(ctx: Context, next: Function, msg: string, event: Event) => void,
...
export interface PluginOnceHooks {
    ...
    onceDocumentVisible?: <Context extends PluginHookContext = PluginHookContext>(ctx: Context, next: Function, event: Event) => void,
    onceDocumentHidden?: <Context extends PluginHookContext = PluginHookContext>(ctx: Context, next: Function, event: Event) => void,
    onceError?: <Context extends PluginHookContext = PluginHookContext>(ctx: Context, next: Function, msg: string, event: Event) => void,
}
